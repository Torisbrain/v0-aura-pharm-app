...
import { ShieldCheck, User, Store, ArrowRight, Lock, Mail, Phone, Building, FileText, CheckCircle2, Eye, EyeOff } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4 text-slate-100">
      <div className="w-full max-w-md bg-slate-900 border border-emerald-500/20 rounded-2xl p-6 shadow-2xl backdrop-blur-xl">
        ...
        {/* TWO-SIDED ROLE SELECTOR TABS — hidden in forgot-password mode */}
        {mode !== 'forgot' && (
        ...
        {mode === 'forgot' && resetSent ? (
          <div className="text-center py-4">
            ...
            <p className="text-xs text-slate-400">We sent a password reset link to {email}.</p>
            <button
              type="button"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 pr-10 text-sm text-slate-100 focus:outline-none focus:border-emerald-500"
                    />
                    <button
                      type="button"
              ...
              >
                {submitting
                  ...
                  ? 'Send Reset Link'
                  : mode === 'signup'
                  ? `Register as ${role === 'patient' ? 'Patient' : 'Pharmacy'}`
                  : 'Sign In'}
